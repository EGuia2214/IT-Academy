...
<?php 
 ...
 ?>
	<tr>
		...
		<td class="text-right"><button type="button" class="btn btn-outline-primary"><a href="modificar.php?id=<?php echo $key['id']?>">Editar</a></button></td>
		<td class=" text-right"><button type="button" class="btn btn-outline-danger"><a href="eliminar.php?id=<?php echo $key['id']?>">Eliminar</a></button></td></td> 
	</tr>
