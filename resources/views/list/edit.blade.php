        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                            <h1>Edit Team</h1>
                            <form action="{{route('list.update', $id)}}" method="POST">
                                ...
                                <p></p>
                                <input type="text" class="form-control" name="stadium" value="{{$stadium}}" >
                                <p></p>
                                @error('stadium')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <p></p>
                                <input type="text" class="form-control" name="foundation_year" value="{{$foundation_year}}">
                                <p></p>
